...
参考：van Hasselt et al., 2016, "Deep Reinforcement Learning with Double Q-learning"

用法：
    python algorithms/deep_rl/double_dqn.py --env CartPole-v1 --episodes 500
"""
...
class DoubleDQNAgent:
    def __init__(
        ...
        self.q_net = MLP(obs_dim, n_actions, list(hidden_sizes)).to(self.device)
...
def train(args) -> List[float]:
    ...
    agent = DoubleDQNAgent(obs_dim=obs_dim, n_actions=n_actions, lr=args.lr, gamma=args.gamma)
